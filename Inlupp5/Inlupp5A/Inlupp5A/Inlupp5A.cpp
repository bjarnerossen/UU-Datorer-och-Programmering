...
// istället f r v rdena 26 och 4 i programmet.
...
// Arrayen  är en GLOBAL KONSTANT och skall allts ej skickas
...
// Här skriver du klassimplementationen
    Text::Text()
    {
        // Sätt attributet analystext till en empty string
        analystext = "";
...
// Funktionsdefinitioner:
    ...
    // Beräkna histogrammet från strängen användaren matat in och lagra bokstavsfrekvensen i arrayen
    bool Text::beraknaHistogramAbs()
    {
        ...
        {
            // Konvertera strängens gemener till versaler och lagra dessa i en temporär char-variabel,
            // om ett tecken redan är en versal lämnar toupper() den orörd
...
/*
 ...
 Uppgift 5A bygger på stort sett på samma kod som i uppgift 4A och har en liknande struktur.
 Den stora skillnaden är att koden är omstrukturerad, så att den fungera objektorienterat.
 Det som krånglar det till för mig är hanteringen av arrayer. Jag hade lite svårt med att första hur
 man få reda på om arrayen innehåller bokstäver eller ej, men det löste sig ju genom att
 använda sig av numbok.
